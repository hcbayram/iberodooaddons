								...
								<td width="40%">
									...
									<table align="center" border="0" width="100%">
										<tbody>
											<tr align="left">
												<xsl:for-each
												select="n1:DespatchAdvice/cac:DespatchSupplierParty/cac:Party">
												<td align="left">
									...
									<table id="customerPartyTable" align="left" border="0">
										<tbody>
											<tr style="height:71px; ">
												...
												<tr>
												<xsl:for-each
												select="n1:DespatchAdvice/cac:DeliveryCustomerParty/cac:Party">
												...
												<xsl:choose>
												<xsl:when
												test="n1:DespatchAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='PARTYTYPE' and text()='TAXFREE']">
												<xsl:for-each
												select="n1:DespatchAdvice/cac:BuyerCustomerParty/cac:Party">
									...
									<table border="1" id="despatchTable">
										<tbody>
											<tr>
												...
												<xsl:for-each
												select="n1:DespatchAdvice/cbc:CustomizationID">
												<xsl:apply-templates/>
												</xsl:for-each>
												</td>
											</tr>
											...
											<tr style="height:13px; ">
												...
												<td align="left">
												<xsl:for-each
												select="n1:DespatchAdvice/cbc:IssueTime">
												<xsl:apply-templates select="."/>
												</xsl:for-each>
												</td>
											</tr>
											...
											<xsl:if test="n1:DespatchAdvice/cac:OrderReference">
												...
												<td align="left">
												<xsl:for-each
												select="n1:DespatchAdvice/cac:OrderReference/cbc:ID">
												<xsl:apply-templates/>
												</xsl:for-each>
												</td>
												</tr>
											...
											<xsl:if
												test="n1:DespatchAdvice/cac:OrderReference/cbc:IssueDate">
												<tr style="height:13px">
												<td align="left">
												<span style="font-weight:bold; ">
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							<tr class="lineTableTr">
								...
								<xsl:if test="(//n1:DespatchAdvice/cbc:ProfileID='HKSIRSALIYE')">
									<td class="lineTableTd" style="width:20%" align="center">
										<span style="font-weight:bold;">
							...
							<xsl:if test="count(//n1:DespatchAdvice/cac:DespatchLine) &lt; 20">
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[11]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[11]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[12]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[12]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[13]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[13]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[14]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[14]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[15]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[15]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[16]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[16]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[17]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[17]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[18]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[18]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[19]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[19]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:DespatchAdvice/cac:DespatchLine[20]">
										<xsl:apply-templates
											select="//n1:DespatchAdvice/cac:DespatchLine[20]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:DespatchAdvice"/>
									</xsl:otherwise>
				...
				<xsl:if test="//n1:DespatchAdvice/cac:AdditionalDocumentReference">
					<table id="lineTable" width="800">
						...
						<tbody>
							...
							<xsl:for-each
								select="//n1:DespatchAdvice/cac:AdditionalDocumentReference">
								<tr align="left" class="lineTableTr">
									<td class="lineTableTd">&#160;&#160;&#160;&#160;&#160;
											<xsl:value-of select="./cbc:ID"/>
									</td>
					...
					<tbody>
						<tr align="left">
							<td id="notesTableTd" height="100">
								...
								<xsl:for-each
									select="//cac:DespatchSupplierParty/cac:Party/cac:Person">
							...
							<td id="notesTableTd" height="100">
								<xsl:for-each select="//cac:CarrierParty">
									<b>&#160;&#160;&#160;&#160;&#160;&#160; Taşıyıcı Firma: </b>
									VKN: <xsl:value-of select="./cac:PartyIdentification/cbc:ID"/>,
										<xsl:value-of select="./cac:PartyName/cbc:Name"/>
									<br/>
								</xsl:for-each>
								<xsl:for-each
									select="//cac:ShipmentStage/cac:TransportMeans/cac:RoadTransport/cbc:LicensePlateID">
									<b>&#160;&#160;&#160;&#160;&#160;&#160; Araç plaka numarası: </b>
									<xsl:value-of select="."/>
									<br/>
								</xsl:for-each>
								<xsl:for-each
									select="//cac:TransportHandlingUnit/cac:TransportEquipment/cbc:ID[@schemeID = 'DORSEPLAKA']">
								...
								<xsl:for-each select="//cac:ShipmentStage/cac:DriverPerson">
									<xsl:if test="cbc:FirstName">
										...
										<xsl:for-each select="cbc:FamilyName">
											<xsl:apply-templates/>
											<xsl:text>&#160;</xsl:text>
										</xsl:for-each>, TCKN: <xsl:for-each
											select="cbc:NationalityID">
											<xsl:apply-templates/>
										</xsl:for-each>
										<br/>
									</xsl:if>
	...
	<xsl:template match="//n1:DespatchAdvice/cac:DespatchLine">
		<tr class="lineTableTr">
			...
			<td class="lineTableTd" align="right">
				...
				<xsl:if
					test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID">
					<xsl:text> </xsl:text>
					<xsl:if
						test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID = &quot;TRL&quot; or ./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID = &quot;TRY&quot;">
						<xsl:text>TL</xsl:text>
					</xsl:if>
					<xsl:if
						test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID != &quot;TRL&quot; and ./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID != &quot;TRY&quot;">
						<xsl:value-of
							select="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cac:Price/cbc:PriceAmount/@currencyID"
						/>
					</xsl:if>
				</xsl:if>
			</td>
			...
			<td class="lineTableTd" align="right">
				...
				<xsl:if
					test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID">
					<xsl:text> </xsl:text>
					<xsl:if
						test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID = &quot;TRL&quot; or ./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID = &quot;TRY&quot;">
						<xsl:text>TL</xsl:text>
					</xsl:if>
					<xsl:if
						test="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID != &quot;TRL&quot; and ./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID != &quot;TRY&quot;">
						<xsl:value-of
							select="./cac:Shipment/cac:GoodsItem/cac:InvoiceLine/cbc:LineExtensionAmount/@currencyID"
						/>
					</xsl:if>
				</xsl:if>
			</td>
