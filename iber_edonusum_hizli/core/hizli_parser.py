# -*- coding: utf-8 -*-
"""
Hızlı Teknoloji e-Dönüşüm — UBL-TR XML parse mantığı (saf Python, Odoo bağımsız).

models/hizli_integrator.py'nin REST API istemci katmanından ayrıştırılmıştır
